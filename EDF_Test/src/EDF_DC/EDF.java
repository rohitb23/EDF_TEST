...
public class EDF {
 ...
 public  EDF(WebDriver driver) {
	...
	@FindBy(xpath = "/html/body/main/div/div[2]/ul/li[8]")
	...
	@FindBy(id = "id_encryption_program")
	public WebElement id_encryption_program;
	...
	@FindBy(xpath = "/html/body/main/div/div[2]/ul/li/a")
	public WebElement schemaAdd;
	
	@FindBy(id = "id_schema_name")
	public WebElement schemaName;
	
	
	@FindBy(id = "id_schema_version")
	public WebElement SchemaVersion;
	
	
	@FindBy(id = "id_schema_format")
	public WebElement schemaFormat;
	
	
	@FindBy(id = "id_schema_delimiter")
	public WebElement schemaDelimiter;
	
	
	@FindBy(id = "id_quote_character")
	public WebElement id_quote_character;
	
	
	@FindBy(id = "id_escape_character")
	public WebElement escape_character;
	
	
	@FindBy(id = "id_schema_package_name")
	public WebElement package_name;
	
	
	@FindBy(id = "id_schema_class_name")
	public WebElement Schema_className;
	...
	@FindBy(xpath = "/html/body/header/nav/div[3]/div/a[8]")
	public WebElement transformTab;
	
	@FindBy(xpath = "/html/body/main/div/div[2]/ul/li/a")
	public WebElement TransformAdd;
	
	@FindBy(id = "id_trfm_name")
	public WebElement TransformName;
	
	
	@FindBy(id = "id_trfm_tech")
	public WebElement transformTech;
	
	@FindBy(id = "id_src_schema")
	public WebElement id_src_schema;
	
	@FindBy(id = "id_tgt_schema")
	public WebElement id_tgt_schema;
	
	@FindBy(id = "id_src_skip_start_match")
	public WebElement skipEx;
	
	@FindBy(xpath = "/html/body/main/div/input")
	public WebElement Transform_ADD;
	
	@FindBy(xpath = "/html/body/main/div/input")
	public WebElement Trans_Submit;
}
